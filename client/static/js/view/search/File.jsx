...
class File extends React.Component {
    constructor(props){
        super(props);
        this.state={
            prev_customerId:this.props.prev_customerId,
            prev_registrationId:this.props.prev_registrationId,
    ...
    getUpdateTime(){
        var _that=this;
        if(!this.state.prev_registrationId){
            return;
        }
        $.ajax({
            type:"get",
            ...
            async:false,
            dataType: "JSON",
            data:{"registrationId":this.state.prev_registrationId},
    ...
    _handleUploadSuccess() {
        alert("上传成功");
        let fileInfos=newGetByType.getByType(this.state.prev_registrationId,this.state.creditFileType);
        let _file_list_data={};
    ...
    getMsg_zx(type,event){
        ...
        if(zxCont.find(".zx-cont").hasClass("hidden")){
            ...
            let fileInfos=newGetByType.getByType(this.state.prev_registrationId,type);
            let _file_list_data={};
    ...
    getLivingIdenty(even){
        ...
        $.ajax({
            ...
            dataType: "JSON",
            data:{
                customerId:this.state.prev_customerId
            },
            success:function(res) {
                if (res.code != 1) {
                    alert(res.msg);
    ...
    render() {
        let fileOption={
            uploadOptions:{
                ...
                param: {
                    registrationId: this.state.prev_registrationId,
        ...
        return (
            <div className="auto-box pr5">
                <div className="toggle-box mt5">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit identy-tit" id='identyFileTypeTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.identyFileType)}>
                    ...
                    <div className="file-toggle-div hidden">
                        <ul className="mt5 border-top-left-radius border-top-right-radius file-tab">
                            <li className="blue-font" onClick={this.identyTab.bind(this,"identification_card_front",0,this.state.prev_registrationId,"identification_card_front")}>正面</li>
                            <li onClick={this.identyTab.bind(this,"identification_card_back",1,this.state.prev_registrationId,"identification_card_back")}>反面</li>
                            <li onClick={this.identyTab.bind(this,"identification_card_withHead",2,this.state.prev_registrationId,"identification_card_withHead")}>手持</li>
                            <li onClick={this.identyTab.bind(this,"face_recognition",3,this.state.prev_registrationId,"face_recognition")}>人脸识别</li>
                        </ul>
                        <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} 
                            _identyData={this.identyData.bind(this)} 
                            prev_registrationId={this.state.prev_registrationId} 
                            prev_loanNumber={this.props.prev_loanNumber} 
                ...
                <div className="toggle-box">
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _fileInfo={this.state.livingIdentyFiles} fileTag="liningIdenty" />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='workFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.workFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.workFileType} _fileInfo={this.state.files.proof_of_work} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this) } />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='liveFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.liveFileType)}>
                ...
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='bankFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.bankFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.bankFileType} _fileInfo={this.state.files.bank_statement} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='phoneFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.phoneFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.phoneFileType} _fileInfo={this.state.files.phone_statement} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                ...
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='pactFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.pactFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.pactFileType} _fileInfo={this.state.files.proof_of_contact} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='houseFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.houseFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.houseFileType} _fileInfo={this.state.files.certificate_of_house_property} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='carFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.carFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.carFileType} _fileInfo={this.state.files.proof_of_car} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='otherFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.otherFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.otherFileType} _fileInfo={this.state.files.others} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                <div className="toggle-box">
                    <h2 className="bar clearfix bar-tit pl20 pr20 mt10 toggle-tit" id='loanFileTit' onClick={this.getfileMsg.bind(this,this.state.prev_registrationId,this.state.loanFileType)}>
                    ...
                    <UpLoadFile prev_userPhoneNo={this.props.prev_userPhoneNo} _identyData={this.identyData.bind(this)} prev_registrationId={this.state.prev_registrationId} prev_loanNumber={this.props.prev_loanNumber} _fileType={this.state.loanFileType} _fileInfo={this.state.files.proof_of_loan_purpose} _setIncline={this.setIncline.bind(this)} _getUpdateTime={this.getUpdateTime.bind(this)} _fileTitIndex={this.state.fileTitIndex} />
                </div>
                {/*大图弹窗*/}
