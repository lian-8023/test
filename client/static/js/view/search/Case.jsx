...
class Case extends React.Component {
    ...
    UNSAFE_componentWillMount(){
        this.getCaseTypes();
        this.getCaseList(this.props.prev_loanNumber,this.props.prev_params);
    }
    UNSAFE_componentWillReceiveProps (nextProps){
        ...
        this.setState({
            ...
            this.getCaseTypes();
            this.getCaseList(this.state.loanNumber,this.state.accountId);
        })
    }
    componentDidMount () {
    ...
    //通过loan_number查询案例记录
    getCaseList(_LoanNumber,_accountId){
        let _that=this;
    ...
    pub_getMsg(_url,type){
        let ajaxData={};
        let _data={};
        if(this.state.loanNumber){
            _data.loanNumber=this.state.loanNumber;
        }
        if(type){
            if(type=="AST"){
                _data.registrationId=this.props.prev_registrationId;
    ...
    saveCaseList(){
        ...
        $.ajax({
            ...
            success:function(res) {
                ...
                _that.getCaseList(_that.state.loanNumber,_that.state.accountId);
                    ...
                    <div className="clearfix mt5 toggle-cont-mid creatCaseCont hidden">
                        <table className="radius-tab" cellPadding={0} cellSpacing={0} frameBorder={0}>
                            <tbody>
                                ...
                                <tr>
                                    <td className="">
                                        <select className="select-gray caseType" name="" id="caseType" style={{"width":"100%"}}>
