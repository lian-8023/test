...
class OperatorReportNew extends React.Component {
    constructor(props){
        ...
        this.state={
            ...
            sourceQuotient:this.props._sourceQuotient,  //渠道来源
            customerId:this.props._customerId,   //customerId
    ...
    getMst(){
        let that=this;
        let _nationalId=this.props._nationalId;
        let _customerId=this.props._customerId;
        if(!_nationalId){
            return;
        }
        if(!_customerId){
