...
class Address extends React.Component {
    ...
    componentDidMount (){
        ...
        //         if($(elem).closest(".address-box").parent().hasClass('ADDRESS')){
        //             return;
        //         }
    ...
    _parse_address(_type,_parent_code,event){
        ...
        let provinceId=this.props.provinceId;
        ...
        if(_type==2){
            ...
            if(event && event.target){
                ...
                if($this.parent().hasClass("rig-list")){
                    ...
                    if(type=='new'){
                        // let _afterModifyData=this.commonStore.afterModifyData?this.commonStore.afterModifyData:{};
                        // let _obj=Object.assign({},_afterModifyData);
                        // _obj[provinceId]=$this.attr("data-code");
                        // this.commonStore.afterModifyData=_obj;
                        let provinceCityIdAreaId_obj=this.commonStore.provinceCityIdAreaId_obj?this.commonStore.provinceCityIdAreaId_obj:{};
                        let _obj=Object.assign({},provinceCityIdAreaId_obj);
                        _obj[provinceId]=$this.attr("data-code");
                        this.commonStore.provinceCityIdAreaId_obj=_obj;
                    }
                }
            }
        }
        if(_type==3){
            ...
            if(event && event.target){
                ...
                if(type=='new'){
                        ...
                        let provinceCityIdAreaId_obj=this.commonStore.provinceCityIdAreaId_obj?this.commonStore.provinceCityIdAreaId_obj:{};
                        let _obj=Object.assign({},provinceCityIdAreaId_obj);
                        _obj[cityId]=$this.attr("data-code");
                        this.commonStore.provinceCityIdAreaId_obj=_obj;
                        // this.commonStore.afterModifyData=_obj;
                }
            }
        ...
        if(_type==0){
            ...
            if(event && event.target){
                ...
                $this.closest('.address-box').removeClass('warnBg');
                if(type=='new'){
                    // let _afterModifyData=this.commonStore.afterModifyData?this.commonStore.afterModifyData:{};
                    // let _obj=Object.assign({},_afterModifyData);
                    // _obj[areaId]=$this.attr("data-code");
                    // this.commonStore.afterModifyData=_obj;
                    let provinceCityIdAreaId_obj=this.commonStore.provinceCityIdAreaId_obj?this.commonStore.provinceCityIdAreaId_obj:{};
                    let _obj=Object.assign({},provinceCityIdAreaId_obj);
                    _obj[areaId]=$this.attr("data-code");
    ...
    render() {
        ...
        let defaultValue=this.props._defaultAddr_val;
        let _className='bar address-box auto pl5 pr5 absolute';
        if(!defaultValue||defaultValue=='-'){
            if(this.props.requird){
                _className='bar address-box auto pl5 pr5 absolute warnBg';
            }
        }
        let getId=this.props.id;
        return (
            <div className={_className} id={getId+'_addr'}>
                {/*value={this.state.selected_text}*/}
                <input type="text" id={getId+'_val'} placeholder={(!defaultValue||defaultValue=='-')?"请选择地址":this.props._defaultAddr_val} readOnly="readOnly" className='left address-inpt' onClick={this.show_address.bind(this)} />
