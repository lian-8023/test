...
class ShopMsgNY extends React.Component {
    constructor(props){
        super(props);
    ...
    render() {
        ...
        identityInfo.bankInfo = identityInfo.userInfo?identityInfo.userInfo.bankInfo:[];//银行卡信息
        identityInfo.guaranteeInfo = identityInfo.userInfo?identityInfo.userInfo.guaranteeInfo:[];//担保人信息
        identityInfo.guaranteeBankInfo = identityInfo.guaranteeInfo.length>0?identityInfo.guaranteeInfo.bankInfo:[];//担保人银行卡信息
        ...
        let productConfigs=cpCommonJs.opinitionObj(ProductConfig['AG']);
