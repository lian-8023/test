...
class UserMsgControler{
    ...
    Edit(edit_req_url,event){
        ...
        oldDataObj.accountId=this.props.allStore.UserInfo2AStore.acountId;
        ...
        if(_this.text()=="修改"){
            ...
            msg_cont.each(function () {
                ...
                if (this_edit_type=="select"){  //下拉框
                    edit_html= _that.props.allStore.UserInfo2AStore.edit_type_select[b_paramName];
            ...
            newDataObj.accountId=this.props.allStore.UserInfo2AStore.acountId;
            newDataObj.loanNumber=this.props.allStore.AcountBarStore.currentLoanNumber;
            if(!condition){
                return;
            }
            newDataObj.customerId=this.props.allStore.UserInfo2AStore.customerId;
            ...
            $.ajax({
                ...
                success:function (res) {
                    ...
                    _that.userInfo2AStore.getUserInfo2A();
